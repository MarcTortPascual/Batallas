...
if (len(sys.argv[1])>=2):
    ...
    print(f"[LOG] make output directory: {dir_prex}/makefile")
    ...
    for i in os.listdir(nolose["fuentes"]):
        ...
        all_rule_dependencies += f"{i.split('.')[0]}.o "

    output.append(f"all:{all_rule_dependencies}\n")
    ...
    print("[OK]: makefile successfully built!!")
